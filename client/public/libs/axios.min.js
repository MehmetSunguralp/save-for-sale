!(function (e, t) {
	...
	var ce,
		...
		ve =
			"undefined" != typeof queueMicrotask ? queueMicrotask.bind(Q) : ("undefined" != typeof process && process.nextTick) || de,
		ye = {
			isArray: N,
			isArrayBuffer: C,
			isBuffer: function (e) {
			...
			isFormData: function (e) {
				...
				return (
					...
					(("function" == typeof FormData && e instanceof FormData) ||
						(U(e.append) &&
							("formdata" === (t = A(e)) || ("object" === t && U(e.toString) && "[object FormData]" === e.toString()))))
				);
			},
	...
	var qe = {
		...
		transformRequest: [
			function (e, t) {
				...
				if (ye.isArrayBuffer(e) || ye.isBuffer(e) || ye.isStream(e) || ye.isFile(e) || ye.isBlob(e) || ye.isReadableStream(e))
					return e;
	...
	function Ge(e, t, r, n, o) {
		return ye.isFunction(n)
			? n.call(this, t, r)
			: (o && (t = r), ye.isString(t) ? (ye.isString(n) ? -1 !== t.indexOf(n) : ye.isRegExp(n) ? n.test(t) : void 0) : void 0);
	}
	var Ke = (function (e, t) {
		function r(e) {
	...
	(Ft.transitional = function (e, t, r) {
		function n(e, t) {
			return "[Axios v1.7.8] Transitional option '" + e + "'" + t + (r ? ". " + r : "");
		}
		return function (r, o, i) {
			...
			return (
				t &&
					!Ut[o] &&
					((Ut[o] = !0), console.warn(n(o, " has been deprecated since v" + t + " and will be removed in the near future"))),
				!e || e(r, o, i)
			);
		};
	}),
